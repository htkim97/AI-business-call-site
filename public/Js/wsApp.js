...
function WindowLoad() {
  ...
  const btns = document.querySelector('button.wsButton');
...
const stopBtn = document.querySelector('.jeonhwa_2');
...
Rec.doCmd = function(cmd,callback){ //cmd: recStart, recStop
  ...
  var url = "http://"+location.hostname+"/users/"+CAPI.userid+"?cmd="+cmd+"&uid="+Rec.uid+"&tag="+Rec.tag;
